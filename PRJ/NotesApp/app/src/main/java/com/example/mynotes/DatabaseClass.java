...
public class DatabaseClass extends SQLiteOpenHelper {
    ...
    void addNotes(String title, String description) {
        ...
        if (resultValue == -1) {
            Toasty.error(context, "Data Not Added", Toast.LENGTH_SHORT).show();
        } else {
            Toasty.success(context, "Data Added Successfully", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void deleteSingleItem(String id) {
        ...
        if (result == -1) {
            Toasty.error(context, "Item Not Deleted", Toast.LENGTH_SHORT).show();
        } else {
            Toasty.success(context, "Item Deleted Successfully", Toast.LENGTH_SHORT).show();
        }
    }
